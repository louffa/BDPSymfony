...
class VirementType extends AbstractType
{
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        $builder
            ...
            ->add('montant',TypeTextType::class,array('label'=>'Montant','required'=>False, 'attr'=>array('class'=>'form-control form-group')))
            ->add('compte',RechercheVirementType::class,array('label'=>'Compte','required'=>False))
